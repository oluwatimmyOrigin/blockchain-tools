...
class DemoTeleBot(TB):
 ...
 Add @a_demo_telebot to your Telegram group
2. Make the bot an admin.
3. Only admins can run the Bot
4. To Start A Raid:
...
5. For advertisement packages, enter /advertise."""
...
*Current likes:* {likes} | *Target:* {self.raid_info[group_id]['likes_threshold']}
*Current replies:* {replies} | *Target:* {self.raid_info[group_id]['replies_threshold']}
*Current reposts:* {retweets} | *Target:* {self.raid_info[group_id]['retweets_threshold']}
*Current bookmarks:* {bookmarks} | *Target:* {self.raid_info[group_id]['bookmarks_threshold']}"""
...
#                 reply = f"""*ETH Transaction Confirmed*\n
...
# *ETH amount:* {eth_amount} ETH"""
                ...
                # await asyncio.run(self.perform_twitter_tasks(group_id))
                else:
